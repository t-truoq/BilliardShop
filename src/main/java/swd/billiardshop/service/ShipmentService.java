...
public class ShipmentService {
    ...
    ghnReq.setServiceTypeId(getServiceTypeId(order.getShippingMethod())); // backup
        ...
        if (ghResp != null) {
            // persist GHN info
            s.setTrackingNumber(ghResp.getOrderCode() != null ? ghResp.getOrderCode() : ("GHN" + order.getOrderNumber()));
            s.setShippingCost(ghResp.getTotalFee() != null ? java.math.BigDecimal.valueOf(ghResp.getTotalFee()) : order.getShippingCost());
            ...
            s.setTrackingNumber("GHN" + order.getOrderNumber());
        }
